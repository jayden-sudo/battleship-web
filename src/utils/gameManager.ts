...
import {
    ...
    REVEAL_RANDOMNESS_LIMIT, DEFAULT_GRID_SIZE,
...
export class GameManager {
    ...
    public destroy() {
        ...
        if (this.currentGameData) {
            GameManager.clearState(this.currentGameData.gameId, this.runtimeState.walletAddress);
        }
    ...
    public restoreState(state: SavedGameState) {
        ...
        if (state.sessionKey) {
            ...
            this.runtimeState.sessionKeyAddress = new ethers.Wallet(state.sessionKey).address;
        }
